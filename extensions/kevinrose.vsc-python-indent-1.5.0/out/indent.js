...
function nextIndentationLevel(lines, tabSize) {
...
(function (Hanging) {
    ...
    Hanging[Hanging["Full"] = 2] = "Full"; // Indent next line, but not the line after. Put text after cursor 2 lines down, cursor 1 line down
...
function currentLineDedentation(lines, tabSize) {
    const dedentKeywords = { elif: "if", else: "if", except: "try", finally: "try" };
